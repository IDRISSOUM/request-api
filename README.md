...
```
cd existing_repo
git remote add origin https://gitlab.com/marz900/request-test.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/marz900/request-test/-/settings/integrations)
